...
if ($_SESSION['logged_in'] != true) {
    ...
    $eventsquery = ("SELECT * FROM Careerevents WHERE last_available_purchase_day_n_time > NOW() AND Start_Date > NOW() ORDER BY Start_Date ASC");
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9">     
                    ...
                    <p> Below are the next Events coming up in order of closest to todays date first. Please note past events will no longer be shown. </p>
                    <div id="lineup">        
                        <p> <?php
