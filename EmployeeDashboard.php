...
if ($_SESSION['logged_in'] != true) {
    ...
    $eventsquery = ("SELECT * FROM Careerevents JOIN Tickets ON Careerevents.Event_ID=Tickets.Event_ID JOIN Potential_Employee ON Tickets.User_ID=Potential_Employee.User_ID WHERE Email = '$email' AND Start_Date > NOW() ORDER BY Start_Date ASC");
...
foreach ($events as $event) {
    ...
    echo "</div>";
    echo "<br></br>";
    echo "<button id = 'booktick'><a href='Get_Ticket.php?EID=" . $eventid . "'>Print or Save Ticket</a></button>";
    echo "<br></br>";
    echo "</div>";
}
?>
